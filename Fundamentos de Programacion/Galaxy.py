...
while Game!=4:
    ...
    ################ MENSAJES #######################
        ...
        screen.blit(fuente.render("PRESIONA SPACE PARA INICIAR", 1, White), (100, 100))
        screen.blit(fuente.render("NIVEL " + str(contadorNiveles),1,White),(250,200))
    ...
    ################ MENSAJES #######################
        screen.blit(fuente.render("RECORDS",1,White),(300,100))
        screen.blit(fuente.render("ABC     "+ str(puntos), 1, White), (300, 150))
        pygame.display.update()
        clock.tick(25)
