...
fondo=pygame.image.load("img/PRINCIPAL CON SCORE.jpg")
##fondo=pygame.transform.scale(fondo,(800,600))  ##En caso de que mi pantalla no mida 800x600
fondo2=pygame.image.load("img/FONDO ESTRELLAS.jpg")
letra=pygame.font.Font(None, 25)  ##configurar tipo y tamaño de letra


while ventanaAbierta:
    Pantalla1=True
#mostrar Pantalla de Juego DE INICIO
    while Pantalla1:
        ...
        ventana.fill(negro)
        ventana.blit(fondo,(0,0))  ##para colocar las imagenes sobre mi pantalla de juego
        mensaje=letra.render("Presiona ESPACIO para continuar",1,blanco)
        ventana.blit(mensaje,(264,320))
    ...
    #Codigo para poner pantalla de JUEGO PARA JUGAR
    PantallaJuego=True
    ...
    while PantallaCreditos:
        ...
        # Codigo para poner un fondo de color.
        ventana.fill(negro)
        ventana.blit(fondo2, (0, 0))  ##para colocar las imagenes sobre mi pantalla de juego
        mensaje = letra.render("CREDITOS DEL JUEGO", 1, blanco)
        ventana.blit(mensaje, (264, 320))
